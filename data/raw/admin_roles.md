...
RelayBoard uses role-based access control (RBAC).

## Built-in Roles

| Role   | Workflows | Users | Settings | Billing |
|--------|-----------|-------|----------|---------|
| Owner  | Full      | Full  | Full     | Full    |
| Admin  | Full      | Full  | Full     | View    |
| Editor | Edit      | View  | None     | None    |
| Viewer | View      | View  | None     | None    |

## Custom Roles

Enterprise customers can define custom roles with granular permissions per resource type.

## API Scopes vs Roles

API scopes control programmatic access. UI roles control console access. They are independent but should be aligned.
## Best Practices

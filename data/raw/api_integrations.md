...
Connect RelayBoard to third-party services.

## Supported Connectors

Built-in connectors include Slack, Microsoft Teams, Jira, Salesforce, and Google Sheets.

## OAuth Connections

Most connectors use OAuth 2.0. Initiate connection via:
...
Use the HTTP action node to call any REST API. Custom integrations support request templating and response mapping.

## Webhook Triggers

External systems can trigger workflows via inbound webhooks. See the Webhooks API reference for outbound webhook configuration.
## Best Practices

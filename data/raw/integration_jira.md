...
Sync issues and automate Jira workflows with RelayBoard.

## Setup

Connect via OAuth in Settings → Integrations → Jira. Requires Jira Cloud.
...
Map RelayBoard workflow variables to Jira custom fields in the integration settings.
## Best Practices

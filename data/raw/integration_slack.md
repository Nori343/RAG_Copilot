...
Send notifications and trigger workflows from Slack.

## Setup

1. Go to Settings → Integrations → Slack
2. Click "Connect to Slack" and authorize the RelayBoard app
3. Select default channels for notifications

## Workflow Actions

The Slack action node supports:
...
Use `/relayboard` in any connected channel to list workflows and trigger executions.

## Permissions

RelayBoard requests `chat:write`, `channels:read`, and `users:read` Slack scopes.
## Best Practices

...
RelayBoard takes security seriously across all plan tiers.
...
Encryption at rest (AES-256) and in transit (TLS 1.2+). Regular penetration testing by third-party firms.

## Compliance Features

Enterprise customers gain access to advanced compliance features including data residency selection, HIPAA BAA, and extended audit retention.

## Reporting Vulnerabilities

Report security issues to security@relayboard.io. We operate a responsible disclosure program.
## Best Practices
